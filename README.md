...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0D1B2A,40:1B4F72,100:2E86AB&height=310&section=header&text=Shivani%20Joshi&fontSize=78&fontAlignY=38&animation=fadeIn&fontColor=FFFFFF&desc=Supply%20Chain%20Analyst%20%7C%20Planning%20%26%20Analytics%20%7C%20S%26OP%20%7C%20Decision%20Intelligence&descAlignY=60&descSize=20&descColor=A8D8EA" />
...
flowchart TD
    subgraph INPUTS["📥  DATA INPUTS"]
        D1[ERP / SAP / Oracle\nTransactional Data]
        D2[Customer Demand\nSignals  5M+]
        D3[Logistics & Shipment\nData  50K+ weekly]
        D4[Inventory &\nWarehouse Data]
    end

    subgraph ANALYTICS["🔬  ANALYTICS LAYER"]
        A1[Demand Forecasting\n& Accuracy Measurement]
        A2[Inventory Optimization\n& Safety Stock Modeling]
...
flowchart TD
    ...
    CENTER <--> SL[📈 Service Level\nTargets]
    CENTER <--> IC[💰 Inventory\nInvestment]
    CENTER <--> TC[🚛 Transportation\nCost]
    CENTER <--> WC[🏦 Working\nCapital]
    CENTER <--> SR[⚠️ Supply\nResilience]

    style CENTER fill:#1B4F72,stroke:#58A6FF,color:#FFFFFF,font-weight:bold
...
║     Every supply chain decision involves tradeoffs — and the best plans  ║
║     make those tradeoffs explicit, not invisible.                        ║
║                                                                          ║
...
<!--
══════════════════════════════════════════════════════════════════════════
  SETUP CHECKLIST — Replace all placeholders before publishing
══════════════════════════════════════════════════════════════════════════
  [ ] YOUR_USERNAME  → your GitHub username (appears in stats, snake, views)
  [ ] LINKEDIN_LINK  → your full LinkedIn profile URL
  [ ] YOUR_EMAIL     → your professional email address
  [ ] PORTFOLIO_LINK → your portfolio or project site URL
  [ ] PROJECT_LINK   → individual project repo URLs (3 places)
  [ ] About Me GIF   → replace Giphy URL with a supply chain / analytics themed GIF
